...
- ae6ec2b: Add the M2A plugin authoring contract with transactional `register(context)`
  registration, typed registry-bound field handles, generic automation and
  activity fields, built-in plugin migration, and an out-of-workspace packaged
